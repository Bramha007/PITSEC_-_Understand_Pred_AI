...
# Faster R-CNN With Optional Custom Anchors
# Supports resnet50 FPN Backbone, Custom Anchor Sizes/Ratios, Local Backbone Weights
# Logs Anchor Summary And Backbone Loading Status
...
# Normalize Anchor Sizes And Ratios Into Tuple-Of-Tuples Per FPN Level
